class UserSessionsController < ApplicationController
  def create
    ...
    redirect_to login_path, alert: "Prihlaseni se nepovedlo. Zkuste to prosim znovu."
  end

  def destroy
    session.delete(:user_id)
    redirect_to login_path, notice: "Odhlaseno."
  end

  def failure
    redirect_to login_path, alert: "Prihlaseni se nepovedlo."
  end
end
